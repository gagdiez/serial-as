...
describe("JSONEncoder Encoder", () => {
  ...
  it("should encode Arrays", () => {
    ...
    const expected:string = '{"u8Arr":[1,2],"u16Arr":[3,4],"u32Arr":[4,5],"u64Arr":["6","7"],"u128Arr":["7","8"],"i8Arr":[-1,-2],"i16Arr":[-3,-4],"i32Arr":[-5,-6],"i64Arr":["-7","-8"],"f32Arr":[1.0,2.0],"f64Arr":[3.1,4.2],"arrI32":[0,1],"arrArr":[[]],"arrUint8":[],"arrObj":[{"s1":0,"s2":1},{"s1":2,"s2":3}]}'
